...
export class CollisionEngine {
  public detectCollisions<T extends RectLike>(item: T, others: T[]): T[] {
    return findCollisions(item, others);
  }

  public findValidPositions<T extends RectLike & { rotation?: Rotation }>(
    item: T,
    others: T[],
    bounds: RectLike,
  ...
  public resolveNonOverlappingPosition<T extends RectLike & { rotation?: Rotation }>(
    item: T,
    desiredPos: Point,
    startPos: Point,
    others: T[],
