import type { Point, RectLike, Rotation } from "../../core/types/geometry";
...
import { calculateDragPosition } from "../rules/dragRules";
import { DEFAULT_AXIS_SCALE, rotateKeepingCenter, type AxisScale } from "../rules/rotationRules";
